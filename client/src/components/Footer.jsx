  ...
  return (
    <footer className="px-6 mt-20 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        ...
        <div className="md:max-w-96">
          <img src={assets.logo}/>
            {/* Black Path */}
            <path
              d="M47.904 28.28q-1.54 0-2.744-.644a5.1 5.1 0 0 1-1.904-1.82..."
              fill="#000"
            />
            {/* Purple Path */}
            <path
              d="m8.75 11.3 6.75 3.884 6.75-3.885M8.75 34.58..."
              stroke="#4F39F6"
              strokeWidth="2.5"
              strokeLinecap="round"
      ...
      <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 ©{" "}
        <a href="https://prebuiltui.com" className="text-blue-600 hover:underline">
          PrebuiltUI
        </a>
        . All Rights Reserved.
      </p>
